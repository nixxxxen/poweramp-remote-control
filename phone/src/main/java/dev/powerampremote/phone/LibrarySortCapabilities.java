...
final class LibrarySortCapabilities {
    ...
    private LibrarySortCapabilities(Set<LibrarySort.Criterion> criteria) {
        this.criteria = Collections.unmodifiableSet(EnumSet.copyOf(criteria));
    }

    static LibrarySortCapabilities defaultOnly() {
        return new LibrarySortCapabilities(EnumSet.of(LibrarySort.Criterion.DEFAULT));
    }
    ...
    static LibrarySortCapabilities parse(String json) {
        try {
            ...
            EnumSet<LibrarySort.Criterion> supported = EnumSet.noneOf(
                    LibrarySort.Criterion.class
            );
            ...
            return new LibrarySortCapabilities(supported);
